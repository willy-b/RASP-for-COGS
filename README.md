...
See also our finished RASP solution to the semantically equivalent ReCOGS task (Wu et al 2023, "ReCOGS: How Incidental Details of a Logical Form Overshadow an Evaluation of Semantic Interpretation", https://doi.org/10.1162/tacl_a_00623 ) in the code associated with that paper at _ (latest revised and improved version based on conference reviewer feedback: _/RASP-for-ReCOGS/_/rasp-for-recogs_pos-2024-draft.pdf ).
...
These are intended be obvious or self-evident conditions, but especially for those who do not read the motivating RASP-for-ReCOGS paper ( _ ):
