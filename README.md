...
A demonstration of how a Transformer without tree-structured/hierarchical representations can perform Kim and Linzen 2020's COGS task ( https://aclanthology.org/2020.emnlp-main.731/ ) includiing recursive aspects of the grammar by unrolling the depth in the decoder loop ([see figures at the bottom of this README](https://github.com/willy-b/RASP-for-COGS#rasp-for-cogs-encoder-decoder-schematic-simplified) or the [paper](https://arxiv.org/abs/2504.15349) for details). 
