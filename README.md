...
A demonstration of how a Transformer with a fixed depth representation, i.e. without tree-structured/hierarchical representations, can perform Kim and Linzen 2020's COGS task ( https://aclanthology.org/2020.emnlp-main.731/ ) including recursive aspects of the grammar by unrolling the input depth in the decoder loop ([see figures at the bottom of this README](https://github.com/willy-b/RASP-for-COGS#rasp-for-cogs-encoder-decoder-schematic-simplified) or the [paper](https://arxiv.org/abs/2504.15349) for details). 
We argue in the [paper](https://arxiv.org/abs/2504.15349) that avoiding tree-structured representations which to be compositional may require activating a number of Transformer layers proportional to the tree depth will make the model more generalizable. This is important because structural generalization errors made by Transformers are well-known. A tree-structured approach is not expected to generalize to tree depths unseen in training as they would require activating deeper layers than were activated in training, whereas an unrolling approach can by reapplying a fixed depth representation repeatedly. See [the literature review here](https://github.com/willy-b/RASP-for-COGS#more-background--literature-review) or [in our paper](https://arxiv.org/abs/2504.15349) for a list of papers supporting this argument.
